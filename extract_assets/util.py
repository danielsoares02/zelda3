...
def set_assets_path(assetsPath):
  global assets_path
  assets_path = assetsPath
  return assets_path

def get_assets_file_path(filePath):
  return os.path.join(assets_path, filePath)

def open_asset(filePath, type = 'r', encoding = None):
  return open(get_assets_file_path(filePath), type, encoding = encoding)
